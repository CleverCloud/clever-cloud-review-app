...
export function todo_getPasswordForgottenForm(params) {
  ...
  return Promise.resolve({
    ...
    queryParams: pickNonNull(params, ['clever_flavor', 'partner_id']),
    // no body
  });
}
...
export function todo_getSignupFormForSource(params) {
  ...
  return Promise.resolve({
    ...
    headers: { Accept: 'text/html' },
    queryParams: pickNonNull(params, ['invitationKey', 'url_next', 'clever_flavor', 'partner_id']),
    // no body
  });
}
...
export function todo_getLoginForm(params) {
  ...
  return Promise.resolve({
    ...
    headers: { Accept: 'text/html' },
    queryParams: pickNonNull(params, ['secondaryEmailKey', 'deletionKey', 'fromAuthorize', 'cli_token', 'clever_flavor', 'partner_id']),
    // no body
  });
}
...
export function todo_getSignupForm(params) {
  ...
  return Promise.resolve({
    ...
    headers: { Accept: 'text/html' },
    queryParams: pickNonNull(params, ['invitationKey', 'url_next', 'clever_flavor', 'subscription_source', 'partner_id']),
    // no body
  });
}
