...
export function getLink(params) {
  ...
  return Promise.resolve({
    ...
    url: `/v2/github/link`,
    headers: { Accept: 'application/json' },
    queryParams: pickNonNull(params, ['transactionId', 'redirectUrl']),
    // no body
  });
}
...
export function getLogin(params) {
  ...
  return Promise.resolve({
    ...
    url: `/v2/github/login`,
    headers: { Accept: 'application/json' },
    queryParams: pickNonNull(params, ['redirectUrl', 'fromAuthorize', 'cli_token', 'clever_flavor', 'oauth_token', 'invitationKey', 'subscriptionSource']),
    // no body
  });
}
...
export function signup(params) {
  ...
  return Promise.resolve({
    ...
    headers: { Accept: 'application/json' },
    queryParams: pickNonNull(params, ['redirectUrl', 'fromAuthorize', 'cli_token', 'clever_flavor', 'oauth_token', 'invitationKey', 'subscriptionSource', 'terms']),
    // no body
  });
}
