...
exports.diagDomainConfig = diagDomainConfig;

var _domains = require("./domains.js");
 ...
 * @return {DomainDiag}
 */
function diagDomainConfig(domainInfo, resolveDnsResult, loadBalancerDnsConfig) {
  if ((0, _domains.isTestDomain)(domainInfo.hostname)) {
    return { ...domainInfo,
      diagSummary: 'managed',
      diagDetails: []
    };
    ...
    return { ...domainInfo,
      ...
      diagDetails: [{
        ...
        record: {
          source: 'expected',
          type: 'CNAME',
          value: loadBalancerDnsConfig.cnameRecord
        }
      }]
    };
  }
    ...
    return { ...domainInfo,
      ...
      diagDetails: [{
        ...
        record: {
          source: 'resolved',
          type: 'CNAME',
          value: resolveDnsResult.cnameRecords[0]
        }
      }]
    };
  }
