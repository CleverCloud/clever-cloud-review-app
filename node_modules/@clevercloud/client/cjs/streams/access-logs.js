...
exports.ApplicationAccessLogStream = void 0;

var _cleverCloudSse = _interopRequireDefault(require("./clever-cloud-sse.js"));
...
class ApplicationAccessLogStream extends _cleverCloudSse.default {
  /**
  ...
  getUrl() {
    const url = this.buildUrl(`/v4/accesslogs/organisations/${this._ownerId}/applications/${this._appId}/accesslogs`, { ...this._options,
...
exports.ApplicationAccessLogStream = ApplicationAccessLogStream;