...
exports.AbstractStream = exports.PingError = exports.AuthenticationError = exports.ERROR_REASON = exports.FORCE_CLOSE_REASON = exports.AUTHENTICATION_REASON = void 0;
...
const AUTHENTICATION_REASON = {
  type: 'close',
  wasClean: true,
  reason: 'Authentication failure',
  code: 4001
};
exports.AUTHENTICATION_REASON = AUTHENTICATION_REASON;
const FORCE_CLOSE_REASON = {
  type: 'close',
  wasClean: true,
  reason: 'Close forced by client',
  code: 4002
};
exports.FORCE_CLOSE_REASON = FORCE_CLOSE_REASON;
const ERROR_REASON = {
  type: 'close',
  wasClean: true,
...
exports.ERROR_REASON = ERROR_REASON;
...
class AbstractStream extends _componentEmitter.default {
  constructor() {
    super();
    this._autoRetry = {
      enabled: false,
  ...
  open(options = {}) {
    const {
      autoRetry = false
    } = options; // Make sure the source is closed before opening it
  ...
  close(reason = FORCE_CLOSE_REASON) {
    // Close source stream
    this._closeSource(); // Always clear all timeouts
